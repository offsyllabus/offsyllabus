...
const programs = [{
  ...
  tagText: "#c4b5fd",
  icon: "🚀",
  desc: "Our flagship 12 month experience. Get full access to both Discovery Sprint and Founder Track, along with",
  highlights: ["Exclusive mentorship", "Hands-on projects", "Industry experiences", "Leadership opportunities", "Portfolio that prepares you for your future", "And a lot more"],

...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-aTvi-EZz.mjs");
...
const manifest = {
  "8d3b0cfa4e6d9dbbe12091806de8d4b4b28b169ad55c5094547cf7daee43fb48": {
    functionName: "login_createServerFn_handler",
    importer: () => import("./programs-github-DrSTswNS.mjs")
  },
  "32f6941306a0a237d403f76d4a05986b0b2dbfe1d129b00a3512753bf5a4605e": {
    functionName: "logout_createServerFn_handler",
    importer: () => import("./programs-github-DrSTswNS.mjs")
  },
  "1121f04b0fa836a7f1067524d757eb93abe4209197ec8d29b65bbd798cbc4e78": {
    functionName: "checkSession_createServerFn_handler",
    importer: () => import("./programs-github-DrSTswNS.mjs")
  },
  "4ebcb690b1d6abcc74f5fa6ff44abb15828bef53b81314f78394de42036dff49": {
    functionName: "addProgram_createServerFn_handler",
    importer: () => import("./programs-github-DrSTswNS.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Br47b9_3.mjs").then((n) => n.r),

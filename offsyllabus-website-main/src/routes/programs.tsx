...
const programs = [
  { name: 'Discovery Sprint', duration: '4 Weeks', tag: 'Beginner', tagColor: 'rgba(34,197,94,0.15)', tagBorder: 'rgba(34,197,94,0.3)', tagText: '#86efac', icon: '🔍', desc: 'A foundational program designed for students who are just starting to explore who they are and what they want from life.', highlights: ['Guided self-discovery exercises', 'Introduction to future-ready skills', 'Peer community access', '2 mentor sessions', 'Personal reflection journal'], forWho: 'Ages 15–17 · First-timers · Students seeking initial clarity' },
  { name: 'Growth Cohort', duration: '12 Weeks', tag: 'Core Program', tagColor: 'rgba(124,58,237,0.15)', tagBorder: 'rgba(124,58,237,0.35)', tagText: '#c4b5fd', icon: '🚀', desc: 'The flagship OffSyllabus experience. A transformative 12-week journey through discovery, exploration, building, and growth.', highlights: ['Full 5-stage journey (Discover → Grow)', 'Real-world projects and challenges', 'Weekly mentor sessions (1:1 + group)', 'Industry visits and field experiences', 'Portfolio development', 'Leadership assignments', 'Community events and networking', 'Final cohort showcase'], forWho: 'Ages 15–21 · Serious learners · Future builders', featured: true },
  { name: 'Founder Track', duration: '8 Weeks', tag: 'Advanced', tagColor: 'rgba(245,158,11,0.12)', tagBorder: 'rgba(245,158,11,0.3)', tagText: '#fcd34d', icon: '💡', desc: 'An intensive program for students who already have an idea or project and want to build it into something real.', highlights: ['Startup methodology workshops', 'Idea validation frameworks', 'Pitch preparation and practice', 'Access to founder mentors', 'MVP building support', 'Investor mindset development'], forWho: 'Ages 17–21 · Aspiring entrepreneurs · Students with ideas' },
]

  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          '_8ZMDgpyeoUtBe9i4KP1yjHiuyEkmXJ_AucXbbPykwk',
      },
      {
        property: 'og:title',
        content: 'OffSyllabus — Education Beyond Marks',
      },
      {
        property: 'og:description',
        content:
          'A structured growth ecosystem helping students discover who they are and build skills that matter.',
      },
      {
        property: 'og:type',
        content: 'website',
    ...
    links: [
      ...
      },
      {
        rel: 'stylesheet',
        href:
          'https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Bricolage+Grotesque:opsz,wght@12..60,400;12..60,500;12..60,600;12..60,700;12..60,800&display=swap',
      },
    ],
      ...
      >
        ...
        >
          <div>
            ...
            >
              A structured growth ecosystem for
              students aged 15–21. Education beyond
              marks.
            </p>
          </div>
...
function RootDocument({
  ...
  const hideGlobalChrome =
    pathname.startsWith('/retail-realtime')
